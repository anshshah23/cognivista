                ...
                <div className="mt-4 space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Receive emails about upcoming events and deadlines
                      </p>
                    </div>
                    <Switch
                      id="email-reminders"
                ...
                <div className="mt-4 space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Receive push notifications when someone comments on your content
                      </p>
                    </div>
                    <Switch
                      id="push-comments"
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Receive push notifications about upcoming events and deadlines
                      </p>
                    </div>
                    <Switch
                      id="push-reminders"
