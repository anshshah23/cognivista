...
export default function AccountSettings () {
  ...
  const [deleteError, setDeleteError] = useState('') // Track errors
  ...
  const handleDeleteAccount = async () => {
    try {
      ...
      const data = await res.json() // Ensure response is JSON
      ...
      if (error instanceof Error) {
        ...
        console.error('Error deleting account:', String(error))
      }
    }
  }
